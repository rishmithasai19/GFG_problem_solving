<h2><a href="https://www.geeksforgeeks.org/problems/series-gp4646/1">N-th Term of GP</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given three integers <strong>a</strong>, <strong>r</strong>, and <strong>n</strong>, where <strong>a </strong>is the first term of a <strong>geometric progression</strong> (GP), <strong>r</strong> is the common ratio, and <strong>n</strong> is the position of the term you need to find. Your task is to calculate the<strong> n-th</strong> term of the <strong>GP</strong>.<br>Since the result can be very large, return the answer modulo 1000000007 (i.e. 10<sup>9</sup>+ 7).<br></span></p>
